     ...
     {/**other stuff */}
          <StyledIndexThreeFlex rem={true} className="ap">
               ...
               <StyledIndexFlex dir="column">
                    ...
                    <p>No doubt, ours is an Eye care centre noted for excellence in our field as evidenced by large number of clients, corporate and individual, throughout Nigeria.</p>
                    </Fade>
                    <p>We are also backed by high quality staff to ensure prompt services and care to all clients in good time.</p>
                    <p>We provide varying eyes exams and solutions. Don't judge the severity rather visit sharpview optometric clinic today.</p>
               </StyledIndexFlex>

               <StyledIndexFlex dir="column">
                    <Lala cu='red' />
                    <h2 style={{padding: 0, margin: 0}}>how we do it</h2>
                    <Fade>
                    ...
                    <p>Also, our team are highly trained and certified practitionals.</p>
               </StyledIndexFlex>
               ...
               <StyledIndexFlex dir="column">
                    ...
                    <Fade>
                    <p>Well, we aim at providing a family like experience for all our clients. we love people and fear God. Now that is a bit to make you want to pay us a visit. </p>
                    </Fade>
               </StyledIndexFlex>
               </ StyledTwoFlex>
